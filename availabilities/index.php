        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="./">Availabilities</a>
                </li>
                <li class="nav-item active">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3" style="display: flex;">
                            ...
                            <select name="supervisor" id="supervisor"
                                class="form-control"><?php echo $supervisors ?></select>
                        </div>
                        <div class="col-md-3" style="display: flex;">
                        ...
                        <div class="col-md-1">
                            <div class="dropdown">
                                <button class="bulk dropdown-toggle" type="button" id="dropdownMenuButton1"
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="tab_availability" class="table responsive wrap">
                                <thead>
                                    <tr>
                                        <th colspan="2">
                                        <th colspan="7">
